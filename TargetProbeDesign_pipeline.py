...
def blat_against_human(TargetSeqs, Outfile, outType):
    os.environ["PATH"] = os.environ["PATH"] + ":/home/baileyj1/share/bin_sync/BLAT/"
    
    parameters = ['blat',
               '/home/baileyj1/share/data_sync/Homo_sapiens/UCSC/hg19/Sequence/Bowtie2Index/genome.fa', #target Sequence
...
def build_bwt_index(TargetGenomeFasta_name, Index_base):
    os.environ["PATH"] = os.environ["PATH"] + ":/home/baileyj1/share/bin_sync/bowtie2-2.1.0"
...
def bowtie_single(Index_base, TargetGenomeFasta_name, ProbesFasta, Out_sam_name):
    os.environ["PATH"] = os.environ["PATH"] + ":/home/baileyj1/share/bin_sync/bowtie2-2.1.0"
    os.environ["PATH"] = os.environ["PATH"] + ":/home/baileyj1/share/bin_sync/samtools-0.1.19"
...
MaxPerMatch = 80
X = 4 #Tiling coverage
Boost_Type = 'Mild_Balanced'  #'Maximum' or 'Balanced' or 'Mild_Balanced'
Pool_factor = 4
